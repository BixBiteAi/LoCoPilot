...
export const inputActiveOptionBorder = registerColor('inputOption.activeBorder',
	{ dark: '#00796b', light: '#00796b', hcDark: contrastBorder, hcLight: contrastBorder },
...
export const inputValidationInfoBackground = registerColor('inputValidation.infoBackground',
	{ dark: '#004d40', light: '#B2DFDB', hcDark: Color.black, hcLight: Color.white },
...
export const buttonBackground = registerColor('button.background',
	{ dark: '#00796b', light: '#00796b', hcDark: Color.black, hcLight: '#004d40' },
...
export const keybindingLabelBorder = registerColor('keybindingLabel.border',
	{ dark: new Color(new RGBA(51, 51, 51, 0.6)), light: new Color(new RGBA(204, 204, 204, 0.4)), hcDark: new Color(new RGBA(77, 182, 172)), hcLight: contrastBorder },
...
export const keybindingLabelBottomBorder = registerColor('keybindingLabel.bottomBorder',
	{ dark: new Color(new RGBA(68, 68, 68, 0.6)), light: new Color(new RGBA(187, 187, 187, 0.4)), hcDark: new Color(new RGBA(77, 182, 172)), hcLight: foreground },
