...
export const badgeBackground = registerColor('badge.background',
	{ dark: '#4D4D4D', light: '#C4C4C4', hcDark: Color.black, hcLight: '#004d40' },
...
export const progressBarBackground = registerColor('progressBar.background',
	{ dark: Color.fromHex('#00796b'), light: Color.fromHex('#00796b'), hcDark: contrastBorder, hcLight: contrastBorder },
...
export const chartLine = registerColor('chart.line',
	{ dark: '#00695c', light: '#00695c', hcDark: '#00695c', hcLight: '#00695c' },
