...
export function registerColors() {
	...
	const debugTokenExpressionType = registerColor('debugTokenExpression.type', { dark: '#4db6ac', light: '#00796b', hcDark: foreground, hcLight: foreground }, 'Foreground color for the token types shown in the debug views (ie. the Variables or Watch view).');
	...
	const debugViewValueChangedHighlight = registerColor('debugView.valueChangedHighlight', '#4db6ac', 'Color used to highlight value changes in the debug views (ie. in the Variables view).');
