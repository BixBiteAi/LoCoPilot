...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		// LoCoPilot/Bixbite logo (theme-aware via CSS, same as welcome/chat)
		const logoDiv = $('div.welcome-logo.locopilot-brand-logo', {
			'aria-label': this.productService.nameLong,
	...
	private buildCategorySlide(categoryID: string, selectedStep?: string, preserveFocus?: boolean) {
		...
		// LoCoPilot logo at top of walkthrough detail (same as welcome screen, theme-aware)
		const detailLogo = $('div.getting-started-detail-logo.locopilot-brand-logo', {
			'aria-label': this.productService.nameLong,
			title: this.productService.nameLong
		});
