...
export interface IChatViewWelcomeContent {
	...
	/** When true, show Bixbite logo (theme-aware) instead of icon. Used for "Build with LoCoPilot" welcome. */
	readonly useBrandLogo?: boolean;
}
...
export class ChatViewWelcomePart extends Disposable {
	...
	public needsRerender(content: IChatViewWelcomeContent): boolean {
		...
		return !!(
			...
			this.content.useBrandLogo !== content.useBrandLogo ||
