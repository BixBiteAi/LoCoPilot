...
AppPublisher=Bixbite AI
AppPublisherURL=https://platform.bixbite.ai/
AppSupportURL=https://platform.bixbite.ai/
AppUpdatesURL=https://platform.bixbite.ai/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=LoCoPilotSetup
Compression=lzma
...
SetupIconFile={#RepoDir}\resources\win32\locopilot.ico
